...
The following content comes from `docs/to_integrate/STYLE_3.md`.
...
# STYLE_3 section pair 1

This file contains one or two `##` sections from docs/to_integrate/STYLE_3.md.
